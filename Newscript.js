...
function showTheTable(){
	...
	document.getElementById('showTheCart').setAttribute('onclick', 'return false');
...
function savedInfo(){
	var codeNo = this.parentNode.parentNode.firstChild.innerHTML,
